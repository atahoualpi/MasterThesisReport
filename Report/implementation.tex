...
We have created our own C\# script that assigns the modal parameters, that we extracted in the analysis part (see section \ref{sec:chuck}), to every one of the objects. This is done independently of the synthesis methods used below.
