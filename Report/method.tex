...
Figure \ref{fig:cup_data} shows the data extracted for the cup object. Each graph corresponds to one of the ``sound areas'' we have divide it into.
...
\subsection{Unity\textregistered}
